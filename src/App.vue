  ...
  <div id="app">
    ...
    <v-app>
      <v-main id="example-3">
        <div class="container">
          <div class="row">
            <span>A mensagem é {{search}} </span>
            <div class="col-lg-12">
              <div class="form-inline">
                <v-text-field label="Divirta-se!" :value="search" id="input-search-principal" v-model="search" placeholder="Divirta-se" hide-details="auto" class="input-search-relative">
                </v-text-field>
...
<script>
  ...
  // var userInput = document.getElementById("input-search-principal").value;
